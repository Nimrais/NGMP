...
|---|---|---|---|---|---|---|---|
| VMP | 0.276 ± 0.031 | 0.588 ± 0.037 | 0.306 ± 0.04 | 0.512 ± 0.044 | 0.583 ± 0.039 | 0.284 ± 0.044 | -0.235 ± 0.03 |
| VMP, 1-step projection | 0.913 ± 0.015 | 0.577 ± 0.035 | 0.284 ± 0.036 | 0.916 ± 0.017 | 0.576 ± 0.035 | 0.277 ± 0.036 | -0.003 ± 0.005 |
