...
| Held out | Projected VMP NLL | Projected VMP, 1 sweep NLL | NGMP NLL | Projected VMP RMSE | Projected VMP, 1 sweep RMSE | NGMP RMSE |
|---:|---:|---:|---:|---:|---:|---:|
